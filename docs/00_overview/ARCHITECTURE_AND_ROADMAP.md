...
> ## ⛔ 已作废（2026-09-08）—— 请勿引用
>
> 本文件是 dw 时期产生的**第二份架构/路线图**，与 `02_architecture/ARCHITECTURE.md` 重复且冲突。
> 当前（v2.0.11-beta）唯一架构真相源是 **[`../02_architecture/ARCHITECTURE.md`](../02_architecture/ARCHITECTURE.md)**，
> 其中 §18 已包含本文件的版本演进与产品分级结论；
> 现行路线图：**[`../ROADMAP.md`](../ROADMAP.md)**（2026-09-10 起唯一有效版本）。
>
> 保留仅为历史留档。**要看架构，去 §02。**
